 ...
 */
//@Ignore
public class Anglesea12kTestSample {
    // have tests in separate classes so that they run, at least und    er maven, in separate JVMs.  kai, nov'17

    Logger log = Logger.getLogger(Anglesea12kTestSample.class);

    @Rule
    public MatsimTestUtils utils = new MatsimTestUtils();

    @Test
    public void testAnglesea12kSample() {
        ...
        String[] args = {
                ...
                "--x-disruptions-file", "scenarios/surf-coast-shire/anglesea-12k/scenario_disruptions.json", //
        };
