 ...
 *
 */
public class FallsFestival65kTest {

    // have tests in separate classes so that they run, at least under maven, in separate JVMs.  kai, nov'17

    private static final Logger log = LoggerFactory.getLogger(FallsFestival65kTest.class);
    ...
    public void testFallsFestival65k() {
        ...
        String[] args = {
                "--config", "scenarios/surf-coast-shire/falls-festival-65k/ees.xml",
        };
        Run.main(args);
