...
public class ExperiencedIndependent extends ArchetypeAgent {

    private Prefix prefix = new ExperiencedIndependent.Prefix();

    public ExperiencedIndependent(String id) {
        super(id);
    }

    class Prefix{
        public String toString() {
            return String.format("%05.0f|%s|%s|%s|", getTime(), getTimeString(), ExperiencedIndependent.class.getSimpleName(), getId());
        }
    }
