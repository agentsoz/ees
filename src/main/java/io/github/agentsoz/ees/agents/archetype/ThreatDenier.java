...
public class ThreatDenier extends ArchetypeAgent {

    private Prefix prefix = new ThreatDenier.Prefix();

    public ThreatDenier(String id) {
        super(id);
    }

    class Prefix{
        public String toString() {
            return String.format("Time %05.0f ThreatDenier %-9s : ", getTime(), getId());
        }
    }
