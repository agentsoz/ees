...
public class DependentEvacuator extends ArchetypeAgent {

    private Prefix prefix = new DependentEvacuator.Prefix();

    public DependentEvacuator(String id) {
        super(id);
    }

    class Prefix{
        public String toString() {
            return String.format("%05.0f|%s|%s|%s|", getTime(), getTimeString(), DependentEvacuator.class.getSimpleName(), getId());
        }
    }
