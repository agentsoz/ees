 ...
 * author: dsingh
 */
public class ExampleRoutingAlgorithmFactory implements LeastCostPathCalculatorFactory {
    ...
    public LeastCostPathCalculator createPathCalculator(Network network, TravelDisutility travelDisutility, TravelTime travelTime) {
        return new ExampleRoutingAlgorithm(network, travelDisutility, travelTime);
    }
}
